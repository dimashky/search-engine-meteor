<template>
    <form @submit.prevent="submit" class="container mx-auto my-4 justify-center items-center flex">
        <div class="w-full max-w-4xl">
            <div class="shadow flex flex-grow rounded-full border border-purple-900 mb-6 overflow-hidden">
                <select v-model="model" class="bg-transparent py-2 outline-none border-r-2 bg-purple-800 text-white px-4">
